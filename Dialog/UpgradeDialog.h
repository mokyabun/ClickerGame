...
class CUpgradeDialog : public GdiDialogBase
{
	DECLARE_DYNAMIC(CUpgradeDialog)

public:
	CUpgradeDialog(CWnd* pParent = nullptr);   // 표준 생성자입니다.
...
private:
	...
	// 업그레이드 버튼 (12개, 2열 6행)
	std::vector<CGdiAtlasButton*> m_upgradeButtons;
	...
	GdiText m_tooltipCategory;
	GdiText m_tooltipPrice;
